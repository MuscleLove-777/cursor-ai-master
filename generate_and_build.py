...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import CursorSEOOptimizer
        ...
        optimizer = CursorSEOOptimizer(config)
    ...
    try:
        from site_generator import CursorSiteGenerator
        site_gen = CursorSiteGenerator(config)
        site_gen.build_site()
